...
**版本管理** 页面同时展示当前界面语言的最新版软件更新说明，升级后仍可查看。发布者在 [`docs/release-notes/`](docs/release-notes/README.md) 中按版本分别编辑简体中文、繁体中文、英文和日文 Markdown，CI 会将内容用于 GitHub Release 正文和应用更新清单。当前语言的说明缺失时直接提示，不回退到其他语言。

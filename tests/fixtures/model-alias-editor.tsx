...
const source = {
  id: 'openai-compatibility:0:0', model: 'public-gpt', displayName: null,
...
mockIPC(async (cmd, rawArgs) => {
  ...
  if (cmd === 'get_model_alias_edit_source') return { ...source, id: `alias-edit:${args.alias}`, model: 'upstream-gpt' };

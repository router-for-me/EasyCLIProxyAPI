...
import { apiQuotaProviderIcon } from '../src/pages/QuotaPage';
...
describe('API quota hostname adapters', () => {
  ...
  it('maps every supported vendor to its own logo asset', () => {
    expect(apiQuotaProviderIcon('deepseek')).toContain('deepseek');
    expect(apiQuotaProviderIcon('stepfun')).toContain('stepfun');
    expect(apiQuotaProviderIcon('siliconflow')).toContain('siliconflow');
    expect(apiQuotaProviderIcon('openrouter')).toContain('openrouter');
    expect(apiQuotaProviderIcon('novita')).toContain('novita');
  });
